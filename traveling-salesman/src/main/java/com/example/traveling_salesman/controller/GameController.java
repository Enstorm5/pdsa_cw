...
public class GameController {
	...
	@PostMapping("/start")
	public GameRoundResponse start(@Valid @RequestBody StartGameRequest request) {
		return gameService.startGame(request);
	}

	@PostMapping("/select-cities")
	public AlgorithmEvaluationResponse selectCities(@Valid @RequestBody SelectCitiesRequest request) {
		return gameService.evaluateSelection(request);
	}

	@PostMapping("/solve")
	public GameResponse solve(@Valid @RequestBody SolveAttemptRequest request) {
